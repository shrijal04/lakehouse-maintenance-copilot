...
def random_timestamp(last_run: datetime):
...
def simulate_incremental_data():
    ...
    with engine.begin() as conn:
        ...
        for row in existing_orders:
            ...
            conn.execute(
                ...
                """),
                {
                    ...
                    "updated_at": random_timestamp(last_run),
                },
            )
        ...
        for i in range(5):
            ...
            order_time = random_timestamp(last_run)
